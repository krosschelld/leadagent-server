...
app.get("/client/export", authMiddleware, async (req, res) => {
  ...
  const rows = [
    ["Date", "Name", "Phone", "Source", "Service", "Status", "AI Reply", "Won", "Job Value"],
    ...leads.map(l => [
...
app.get("/widget.js", (req, res) => {
  ...
  const apiUrl = process.env.APP_URL
    ? process.env.APP_URL.replace("app.bleedleads.com", "leadagent-server-production.up.railway.app")
    : "https://leadagent-server-production.up.railway.app";
